...
function normalizeStockRow(row: ScreenerApiRow): StockRow {
    return {
        ...
        fundamental: {
            ...
            targetPrice: row.fundamental.target_price,
            high52w: row.fundamental.high_52w,
            shortInterest: row.fundamental.short_interest,
            epsPast5y: row.fundamental.eps_past_5y,
            epsQuarterOverQuarter: row.fundamental.eps_quarter_over_quarter,
            salesPast5y: row.fundamental.sales_past_5y,
            salesQuarterOverQuarter: row.fundamental.sales_quarter_over_quarter,
            roe: row.fundamental.roe,
            roic: row.fundamental.roic,
            grossMargin: row.fundamental.gross_margin,
            operatingMargin: row.fundamental.operating_margin,
            profitMargin: row.fundamental.profit_margin,
            debtEquity: row.fundamental.debt_equity,
            potentialStock: row.fundamental.potential_stock === 1,
            ...
            grossMarginScore: row.fundamental.gross_margin_score,
