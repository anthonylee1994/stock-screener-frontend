...
export const FilterSelect = React.memo<Props>(({label, options, placeholder, value, onChange}) => {
    return (
        <Select className="text-neutral-950 dark:text-neutral-100" placeholder={placeholder} value={value} onChange={onChange}>
            ...
            <Select.Trigger className="h-10 rounded-4xl border-neutral-200 bg-neutral-100 text-sm font-medium text-neutral-950 shadow-none dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-100 transition-none">
                <Select.Value />
                <Select.Indicator />
            </Select.Trigger>
