...
import {Chip, Popover, Spinner, Table} from "@heroui/react";
    ...
    ({
        ...
        return (
            <Table className="hidden lg:block">
                <Table.ScrollContainer className="max-h-[calc(100vh-16rem)] overflow-y-auto">
...
function renderTableBody(
    ...
    return (
        <React.Fragment>
            ...
            <LoadMoreRow error={loadMoreError} hasMore={hasMore} isLoadingMore={isLoadingMore} onLoadMore={onLoadMore} />
        </React.Fragment>
    );
}
...
function LoadMoreRow({error, hasMore, isLoadingMore, onLoadMore}: LoadMoreRowProps): React.ReactNode {
    ...
    return (
        <Table.Row>
            <Table.Cell colSpan={9}>
                <div className="py-5 text-center text-sm text-neutral-500 dark:text-neutral-400">
                    {!isLoadingMore && error ? (
